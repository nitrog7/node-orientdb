...
var path = require('path'), MigrationManager = require('../../migration/manager');
...
exports.list = function() {
  return this.manager().list().then(function(names) {
...
exports.applied = function() {
  return this.manager().listApplied().then(function(names) {
...
exports.create = function() {
  ...
  return this.manager().create(name).then(function(filename) {
...
exports.up = function(limit) {
  ...
  return this.manager().up(limit).then(function(results) {
...
exports.down = function(limit) {
  ...
  return this.manager().down(limit).then(function(results) {
