 ...
 *
 * @param   {Object|Array} args The item(s) to add.
...
Index.prototype.add = function(args) {
  ...
  return Promise.map(args, function(item) {
    return this.db.query('INSERT INTO index:' + this.name + ' (key, rid) VALUES ("' + this.db.escape(item.key) + '", ' +
...
Index.prototype.set = function(key, value) {
  return this.db.query('INSERT INTO index:' + this.name + ' (key, rid) VALUES ("' + this.db.escape(key) + '", ' +
