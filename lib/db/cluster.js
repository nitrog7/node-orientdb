...
exports.getByName = function(name, refresh) {
  ...
  if(!refresh && this.cluster.cached && this.cluster.cached.names[name]) {
    ...
    return this.cluster.list(refresh).bind(this).then(function() {
...
exports.delete = function(nameOrId) {
  return this.cluster.get(nameOrId).bind(this).then(function(cluster) {
      if(!cluster) {
 ...
 * @promise {Number}          The number of records in the cluster.
 */
