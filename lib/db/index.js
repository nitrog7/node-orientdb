...
/**
 * Execute an SQL query against the database and retrieve the raw, parsed response.
 *
...
/**
 * Execute an SQL query against the database and retrieve the results
 *
 * @param   {String} query   The query or command to execute.
 * @param   {Object} options The options for the query / command.
 * @promise {Mixed}          The results of the query / command.
...
/**
 * Shortcut to close the server connection
 *
 * @promise {Mixed}          The results of the query / command.
 */
