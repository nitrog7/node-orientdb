...
Class.prototype.list = function(limit, offset) {
  var query = 'SELECT * FROM ' + this.name, config = {};

  if(limit && _.isObject(limit)) {
    config = limit;
    limit = config.limit;
...
Class.prototype.create = function(record) {
  ...
  record['@class'] = this;
  return this.db.record.create(record).then(function(record) {
    delete record['@class'];
    return record;
  });
};
...
Class.prototype.reload = function() {
  return this.db.class.get(this.originalName, true).bind(this).then(function(item) {
    this.configure(item);
    return this;
  });
};
...
exports.list = function(refresh) {
  ...
  return this.send('record-load', {
    ...
    .then(this.class.cacheData).then(function() {
...
exports.delete = function(name) {
  return this.exec('DROP CLASS ' + name).bind(this).then(function() {
    return this.class.list(true);
  }).then(function(classes) {
    return this;
  });
...
exports.get = function(name, refresh) {
  if(!refresh && this.class.cached && this.class.cached.names[name]) {
    ...
    return this.class.list(refresh).bind(this).then(function() {
